...
export interface CommentAttributes {
  ...
  createdAt?: Date;
  updatedAt?: Date;
  post_id?: PostAttributes | PostAttributes['id'];
  author_id?: UserAttributes | UserAttributes['id'];
...
export interface CommentInstance extends Sequelize.Instance<CommentAttributes>, CommentAttributes {
  ...
  createPost: Sequelize.BelongsToManyCreateAssociationMixinOptions;
  ...
  createAuthor: Sequelize.BelongsToCreateAssociationMixinOptions;
